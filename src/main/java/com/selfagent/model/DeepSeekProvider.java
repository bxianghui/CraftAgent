...
@ModelProvider(name = "deepseek", description = "DeepSeek Provider — OpenAI-compatible API")
public class DeepSeekProvider implements LLMProvider {
    ...
    public DeepSeekProvider(String apiKey, String model, String baseUrl, float temperature) {
        this.apiKey = apiKey;
    ...
    public Stream<ChatChunk> stream(ChatRequest request) {
        try {
            ...
            Map<Integer, String> indexToId = new java.util.HashMap<>();
            ...
            throw new RuntimeException("DeepSeek stream error", e);
        }
    }
